...
easy_datatable(
  datasets$filter_compounds_by_qc_mv_removed,
...
easy_datatable(
  datasets$filter_compounds_by_qc_rsd_removed,
...
easy_datatable(
  datasets$filter_compounds_by_sample_all_mv_removed,
...
easy_datatable(
  datasets$filter_compounds_by_sample_mv_removed,
...
#      Valid ratio of NAs is max 0.2 by default
easy_datatable(
  datasets$filter_samples_by_compound_mv_removed,
