...
df.filtered %>%
  ...
  easy_datatable(caption = "Long table of normalized intensities")
...
for (i in seq_along(sub_groups)) {
  ...
  # WIDE EXPORTS WOULD NEED MORE UNIQUE NAMES (e.g. ID+POS+BATCH)
  # SINCE ID MIGHT NOT BE UNIQUE (e.g. with pools)
