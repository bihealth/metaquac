...
for (i in seq_along(sub_groups)) {
  ...
  #     select(Compound,Sample.Identification,condition,Analyte.Peak.Area.Normalised,metabolite_mean_peak_area,relative_standard_deviation)
  #   
  #   # Export long format containing all data together
  #   write.csv(df.HOS.output.long, file.path(export_path, paste0("lowcon_", sub_groups[i], "_LC_normalised_data_long.csv")),  row.names = FALSE)
  #   
  ...
  #     select(Compound, sample_name, Analyte.Peak.Area.Normalised) %>%
  #     spread(sample_name, Analyte.Peak.Area.Normalised)
  #   
  #   write.csv(df.HOS.output.intensity.wide, file.path(export_path, paste0("lowcon_", sub_groups[i], "_LC_normalised_intensities_wide.csv")), row.names = FALSE)
  #   
  ...
  #   
  #   write.csv(df.HOS.output.mean.wide, file.path(export_path, paste0("lowcon_", sub_groups[i], "_LC_mean_intensity_wide.csv")), row.names = FALSE)
  #   # 
  ...
  #   
  #   write.csv(df.HOS.output.rsd.wide, file.path(export_path, paste0("lowcon_", sub_groups[i], "_LC_rsd_wide.csv")), row.names = FALSE)
  # }
}
