...
easy_datatable(
  data = table_bio_replicate_rsd(
    bcdata = biocrates, rep_variables = rep_variables,
    sample_types = sample_types, unit = "Class"
  ),
...
if (all(c("BR", "TR") %in% names(biocrates))){
  ...
  easy_datatable(
    data = table_bio_replicate_rsd(
      bcdata = biocrates, rep_variables = rep_variables,
      sample_types = sample_types, tec_reps_use = "mean", unit = "Class"
    ),
    caption = paste0("Median class %RSDs per study groups"))
  ...
  easy_datatable(
    data = table_bio_replicate_rsd(
      bcdata = biocrates, rep_variables = rep_variables,
      sample_types = sample_types, tec_reps_use = "median", unit = "Class"
    ),
    caption = paste0("Median class %RSDs per study groups"))
}
```
...
if (all(c("BR", "TR") %in% names(biocrates))){
  ...
  easy_datatable(
    data = table_bio_replicate_rsd(
      bcdata = biocrates, rep_variables = rep_variables,
      sample_types = sample_types, tec_reps_use = "only", unit = "Class"
    ),
    caption = paste0("Median class %RSDs per study groups"))
}
```
