...
params:
  ...
  # (Biocrates' Sample) (default 0.3, exclusive, disable with NULL) and maximum ratio of missing
  # values allowed per biological sample (Biocrates' Sample) (default 0.2, exclusive, disable with
  # NULL).
...
# Set chunk eval variable defaults
CONTINUE <- TRUE
MULTIBATCH <- FALSE
